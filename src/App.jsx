...
function App({ wkey }) {
  ...
  const handleSubmit = async (event) => {
    ...
    await axios.post("http://3.29.188.19:8002/v1/pub/call", formDataObject, {
      headers: {
        WIDGET_KEY: wkey,
      },
    });
  ...
  const styles = {
    main: {
      position: "relative",
      zIndex: 50,
      fontFamily: data?.design?.font_family || "",
    },
    openButton: {
      position: "fixed",
      bottom: "2.5rem",
        ...
        <div id="widget-container" ref={formRef} style={styles.wrapper}>
          ...
          {!data?.design?.logo && (
            ...
            >
              ...
              />
              <path class="cls-1" d="M21.31,74.13H22v3.18h-.73Z" />
              <path
                class="cls-1"
              ...
              />
              <path class="cls-1" d="M73.15,74.13h.73v3.18h-.73Z" />
              <path
                class="cls-1"
              ...
              />
              <path class="cls-1" d="M100.2,74.13h.74v2.58h1.59v.6H100.2Z" />
              <path class="cls-1" d="M103.85,74.13h.73v3.18h-.73Z" />
              <path
                class="cls-1"
